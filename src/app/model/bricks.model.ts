...
export const Informations: Information[] =  [
    ...
    {icon: 'information-circle-outline', info: 'Safety Information',form: false, description: 'We keep your personal information private and safe and put you in control'}
  ]
